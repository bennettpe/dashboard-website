...
function getData(error, salesData) {
    ...
    /* Colors and color scales */
         var SchemeSet3 = (["#8dd3c7",   // Monte Carlo
                            "#ffffb3",   // Portafino
    ...
    /* Create dc.numberDisplay(s) */                   
            costSum
                   ...
                   .html({
                          some:"<span> Total Cost &nbsp" + "<span style=\"color:#DC143C;\"> <strong> £%number     </strong> </span>",
                          none:"<span> Total Cost &nbsp" + "<span style=\"color:#DC143C;\"> <strong> Zero Records </strong> </span>"
                        })
            ...
            profitSum
                   ...
                   .formatNumber(d3.format(",.0f"))
                   .html({
                          some:"<span> Total Profit &nbsp" + "<span style=\"color:#556B2F;\"> <strong> £%number     </strong> </span>",
                          none:"<span> Total Profit &nbsp" + "<span style=\"color:#556B2F;\"> <strong> Zero Records </strong> </span>"
                        })
                   .transitionDuration(500)
            ...
            revenueSum
                   ...
                   .formatNumber(d3.format(",.0f"))
                   .html({
                          some:"<span> Total Revenue &nbsp" + "<span style=\"color:#6495ED;\"> <strong> £%number     </strong> </span>",
                          none:"<span> Total Revenue &nbsp" + "<span style=\"color:#6495ED;\"> <strong> Zero Records </strong> </span>"
                        })
                   .transitionDuration(500)    
           ...
           unitCountSum 
                   ...
                   .formatNumber(d3.format(",.0f"))
                   .html({
                          some:"<span> Total Units Sold &nbsp" + "<span style=\"color:#6495ED;\"> <strong> %number      </strong> </span>",
